      ...
      <div className="mb-3 flex flex-wrap items-center gap-2">
        {draft ? (
          <>
            ...
            <button onClick={() => setDraft(null)} disabled={busy} className={`${btn} border-slate-200 bg-white hover:bg-slate-50`}>
            ...
            <span className="text-sm text-slate-500">Geser kartu, atau titik biru pada garis untuk mengubah tinggi garis.</span>
          </>
        ) : (
